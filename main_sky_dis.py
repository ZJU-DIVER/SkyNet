...
if __name__ == '__main__':
    ...
    if params.mode == 'train':
        ...
        if len(sys.argv) >= 2:
            ...
            train_file = "data/skyline10k-10to1k-2d-inde-train.txt"
        ...
        with train_graph.as_default(), tf.compat.v1.container("train"):
            ...
            train_model, train_op, loss = build_multi_gpu_model(params, SkyNet_Dis, train_iter)
        ...
        with eval_graph.as_default(), tf.compat.v1.container("eval"):
            ...
            eval_model, op, eval_loss = build_multi_gpu_model(params, SkyNet_Dis, eval_iter)
        ...
        with infer_graph.as_default(), tf.compat.v1.container('infer'):
            ...
            infer_model = SkyNet_Dis(params, params.mode, infer_iter.get_next())
